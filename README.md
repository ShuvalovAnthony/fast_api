...
All environment variabels should start with "FAST_API_" prefix.
...
```
docker run -p "5432:5432" -e "POSTGRES_PASSWORD=fast_api" -e "POSTGRES_USER=fast_api" -e "POSTGRES_DB=fast_api" postgres:13.8-bullseye
```
