...
from fast_api.services.rabbit.dependencies import get_rmq_channel_pool
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from fast_api.db.meta import meta  # noqa: WPS433
    from fast_api.db.models import load_all_models  # noqa: WPS433
